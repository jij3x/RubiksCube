...
void row2row(color_t *src_ptr, unsigned int src_y, unsigned int src_x, direction_t src_dir,
        color_t *tgt_ptr, unsigned int tgt_y, unsigned int tgt_x, direction_t tgt_dir,
        unsigned int layers) {
    assert(layers > 0);
...
void row2col(color_t *src_ptr, unsigned int src_y, unsigned int src_x, direction_t src_dir,
        color_t *tgt_ptr, unsigned int tgt_y, unsigned int tgt_x, direction_t tgt_dir,
        unsigned int layers) {
    assert(layers > 0);
    assert((src_dir == EAST && src_x == 0) || (src_dir == WEST && src_x == layers - 1));
...
void col2row(color_t *src_ptr, unsigned int src_y, unsigned int src_x, direction_t src_dir,
        color_t *tgt_ptr, unsigned int tgt_y, unsigned int tgt_x, direction_t tgt_dir,
        unsigned int layers) {
    assert(layers > 0);
...
void col2col(color_t *src_ptr, unsigned int src_y, unsigned int src_x, direction_t src_dir,
        color_t *tgt_ptr, unsigned int tgt_y, unsigned int tgt_x, direction_t tgt_dir,
        unsigned int layers) {
    assert(layers > 0);
    assert((src_dir == SOUTH && src_y == 0) || (src_dir == NORTH && src_y == layers - 1));
